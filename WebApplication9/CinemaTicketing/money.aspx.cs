    ...
    public partial class money : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sqlyuju = "SELECT count(*) FROM UserManagement WHERE Username = '" +username+ "'and PayPassword = '" + payPassword + "'";
                ...
                if (n >= 1)
                {
                    ...
                    {
                        sqlconnection.openDatabase();
                        string sqlyuju1 = "SELECT Name FROM UserManagement WHERE Username = '" + username + "'";
