<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homePage2.aspx.cs" Inherits="CinemaTicketingSystem.homePage2" %>
...
<body>
    ...
    <div id = "headbar">
		...
		<hr color = #FFFFFF>
		<div class = "section1 floatleft">
			<ul>
				<li><a href="homePage2.aspx">首页</a></li>
				<li><a href="movieInfo.aspx">影片资讯</a></li>
			</ul>
		</div>
		<div class = "section1 floatright">
		<ul>
			<li>您好，<%=username %>！</li>
			<li><a href="personCenter_main.aspx">个人中心</a></li>
			
			<li><a href="homePage1.aspx">退出登录</a></li>
		</ul>	
		</div>
		<div clear="clear"></div>
	</div>
