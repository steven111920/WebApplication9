...
namespace CinemaTicketingSystem
{
    public partial class backStage_adInfomationUpdate : System.Web.UI.Page
    {
        ...
        {
            old_id = (string)Session["username"];
            string sqlyuju = "select * from Administrator where Name = '" + old_id + "'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
          ...
          //  string id = (string)Session["id"];//获取前台网页所提交的数据
            ...
            try
            {
                ...
                //将获取到的数据更新到数据库中
                sqlyuju = "update Administrator set Name='" + name + "', Sex='" + sex + "',Email = '" + email + "',Phone='" + phone + "' where Username='" +username + "';";
                SqlCommand cmd = sqlconnection.executeSQL(sqlyuju);
                cmd.ExecuteNonQuery();
