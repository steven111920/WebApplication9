<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backStage_movieUpdate.aspx.cs" Inherits="CinemaTicketingSystem.backStage_movieUpdate" %>
			...
			<div class="movie_manage">	
				...
				<table style="border:0px;margin-left:150px;" >
					<tr height="40px">
						...
						<td><%=updateMovie.getMovieNo() %></td>
					</tr>
					<tr height="40px">
						<td align="right">影片名称：</td>
						<td><input type="text" name="movieName" value="<%=updateMovie.getMovieName() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">类型：</td>
						<td><input type="text" name="type" value="<%=updateMovie.getType() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">国家：</td>
						<td><input type="text" name="country" value="<%=updateMovie.getCountry() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">片长：</td>
						<td><input type="text" name="minute" value="<%=updateMovie.getMinute() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">导演：</td>
						<td><input type="text" name="director" value="<%=updateMovie.getDirector() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">主演/配音：</td>
						<td><input type="text" name="actors" value="<%=updateMovie.getActors() %>"></input></td>
					</tr>
					<tr height="40px">
						<td align="right">上映日期：</td>
						<td><input type="date" name="playDate" style="width:173" value="<%=updateMovie.getPlayDate() %>"/></td>
					</tr>
					<tr height="40px">
						<td align="right">价格：</td>
						<td><input type="text" name="Price" value="<%=updateMovie.getPrice() %>"></input></td>
					</tr>
					</table>
					<br>
				<hr height="2px" width="1000px">
				<table style="border:0px;margin-left:150px;" >
					<tr height="80px">
						...
						<td><textarea name="summary" rows="3px" cols="80px" ><%=updateMovie.getSummary() %></textarea></td>
					</tr>
					<tr height="100px">
						<td align="right">故事简介：</td>
						<td><textarea name="briefIntroduction" rows="8px" cols="80px"><%=updateMovie.getBriefIntroduction() %></textarea></td>
					</tr>
				</table>
				<hr height="2px" width="1000px">	
					<!-- 片花图片 -->
				...
				<hr height="2px" width="1000px">
				<asp:Button ID="Button1" runat="server" Text="修改" Width="45px" 
                    onclick="Button1_Click" />
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" value="返回" onclick="window.location.href='backStage_movieManagement.aspx'"></input>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="reset" onclick="window.location.href='backStage_movieUpdate.aspx'"></input>
			</div>
			<div class="clear"></div>
		</div>
		<!-- 右边内容结束 -->
