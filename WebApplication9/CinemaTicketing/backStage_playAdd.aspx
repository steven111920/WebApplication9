<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backStage_playAdd.aspx.cs" Inherits="CinemaTicketingSystem.backStage_playAdd" %>
			...
			<div class="movie_manage">	
				...
				<table style="border:0px;margin-left:150px;margin:auto" >
					...
					<tr height="40px">
						...
						<td> <input type="date" name="playingDate" /></td>
					</tr>
					<tr height="40px">
